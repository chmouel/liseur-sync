...
| [0049](0049-the-web-reader-paginates.md) | The web reader paginates and shows its bar | Now | Accepted; implemented | One paginated reader layout, with continuous scroll removed even from older saved browser preferences; the bar starts visible on every viewport and auto-hide remains opt-in; amends [0012](0012-reader-engine-foliate.md) and [0031](0031-web-reader-footer.md) |
