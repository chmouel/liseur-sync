...
|---|---|---|---|---|
| [0001](0001-content-server.md) | Become a content server | — | MVP implemented | Abandoned-job sweep, then covers |
...
| [0005](0005-upload-and-ingestion.md) | Upload and ingestion pipeline | MVP | Built | Abandoned-job sweep |
