...
|---|---|---|---|---|
| [0001](0001-content-server.md) | Become a content server | — | MVP implemented | The web reader, which needs a decision before code |
...
| [0007](0007-web-reader.md) | Web reader | Later | Deferred | The catalog is now rich enough; this ADR needs replacing |
