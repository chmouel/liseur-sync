...
var registeredRouteGates = map[string]routeGate{
	...
	"GET /v1/books/{id}/publication/manifest.json":                     gateLibraryRead,
	"HEAD /v1/books/{id}/publication/manifest.json":                    gateLibraryRead,
	"GET /v1/books/{id}/publication/{digest}/positions.json":           gateLibraryRead,
	"HEAD /v1/books/{id}/publication/{digest}/positions.json":          gateLibraryRead,
	"GET /v1/books/{id}/publication/{digest}/resources/{resource...}":  gateLibraryRead,
	"HEAD /v1/books/{id}/publication/{digest}/resources/{resource...}": gateLibraryRead,
